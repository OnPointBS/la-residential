        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <TeamMember
              ...
              description="Co-founder and operations manager, Lauren brings decades of experience in residential construction and ensures every project meets our high standards."
              imageName="Lauren"
            />
            ...
            <TeamMember
              ...
              description="Co-founder and lead designer, Adam specializes in creating homes that perfectly balance functionality with beautiful design and modern amenities."
              imageName="Adam"
            />
          </div>
        </div>

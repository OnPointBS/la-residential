...
interface AdvancedFloorPlanSearchProps {
  searchTerm: string;
  setSearchTerm: (term: string) => void;
  bedroomFilter: string;
  setBedroomFilter: (bedrooms: string) => void;
  bathroomFilter: string;
  setBathroomFilter: (bathrooms: string) => void;
...
export function AdvancedFloorPlanSearch({
  searchTerm,
  setSearchTerm,
  bedroomFilter,
  setBedroomFilter,
